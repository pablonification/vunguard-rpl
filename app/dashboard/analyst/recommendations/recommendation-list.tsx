...
export default function RecommendationList({ initialRecommendations }: RecommendationListProps) {
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
          <div>
            ...
            <CardDescription>Manage and track your investment recommendations</CardDescription>
          </div>
